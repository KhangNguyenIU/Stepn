...
async function main() {
    ...
    await marketplaceInstance.connect(deployer).addNewNFTType(sneakerInstance.address)
    await marketplaceInstance.connect(deployer).addNewNFTType(gemInstance.address)
    await marketplaceInstance.connect(deployer).addNewNFTType(mintingScrollInstance.address)
    await marketplaceInstance.connect(deployer).addNewNFTType(shoeBoxInstance.address)
